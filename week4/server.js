...
// all of our files that we want to be on the front end will go inside of our "public" folder
...
// 1st param: url, location where we want to get data from
// 2nd param: function, action to happen when this route is hit
// app.get("/test", callback)
// function callback(request, response){}

app.get("/test", (request, response) => {
    // we only wnt to send back one type of response
